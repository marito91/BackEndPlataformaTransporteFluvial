                  ...
                  if (error) {
                    ...
                    newOrder.save(function (error) {
                      if (error) {
                        ...
                        return res.send({
                          estado: "ok",
                          msg: `Orden creada exitosamente con ID número ${orderId}. En la página de inicio podrá encontrar más detalles de su orden. Muchas gracias por usar nuestro servicio.`
                        });
                      }
                    });
                  }
                  ...
                  if (error) {
                    ...
                    newOrder.save(function (error) {
                      if (error) {
                        ...
                        return res.send({
                          estado: "ok",
                          msg: `Orden creada exitosamente con ID número ${orderId}. En breve lo estaremos contactando para ofrecerle más detalles de su orden. Muchas gracias por usar nuestro servicio.`
                        });
                      }
                    });
                  }
  ...
  */
  ...
  ordenModel.findOne({
    ...
    if (error) {
      return res.send({
        estado: "error",
        msg: "No se encontró la orden solicitada."
      });
    } else {
      if (orden != null && orden != undefined) {
        res.send({
          estado: "ok",
          msg: "Orden encontrada con éxito.",
          orden
        });
      } else {
        res.send({
  ...
  */
  ...
  ordenModel.find({
    ...
    if (error) {
      return res.send({
        estado: "error",
        msg: "No se encontraron órdenes."
      });
    } else {
      if (ordenes != null && ordenes != undefined) {
        res.send({
          estado: "ok",
          msg: "Ordenes encontradas con éxito.",
          data: ordenes
        });
      } else {
        res.send({
...
//# sourceMappingURL=ordenesRutas.js.map